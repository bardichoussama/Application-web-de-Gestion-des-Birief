...
<!-- Sidebar -->
<div id="docs-sidebar" class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-80 bg-bodybackground  border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 ">
    <div class="px-6">
        <a href="#" class="flex justify-center items-center text-2xl font-semibold text-gray-900 mt-4"><svg class="w-16 h-16 text-primary  " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                <path fill-rule="evenodd" d="M11 4.717c-2.286-.58-4.16-.756-7.045-.71A1.99 1.99 0 0 0 2 6v11c0 1.133.934 2.022 2.044 2.007 2.759-.038 4.5.16 6.956.791V4.717Zm2 15.081c2.456-.631 4.198-.829 6.956-.791A2.013 2.013 0 0 0 22 16.999V6a1.99 1.99 0 0 0-1.955-1.993c-2.885-.046-4.76.13-7.045.71v15.081Z" clip-rule="evenodd" />
            </svg>
            <div class="flex flex-col">
                <p class="text-2xl text-primary">Briefed</p><br>
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap mt-11" data-hs-accordion-always-open>
        <ul class="space-y-11">
            <li>
                <a href="../formateur/dashboard_formateur.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-lg text-gray-800 ">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="../formateur/create_brief.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-lg text-gray-800  ">Create Brief</span>
                </a>
            </li>
            <li>
                <a href="../formateur/briefs_list.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-lg text-gray-800  ">Briefs</span>
                </a>
            </li>
            <li>
                <a href="../formateur/learners.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    <svg class="w-6 h-6 text-primary " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M12 6a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-1.5 8a4 4 0 0 0-4 4 2 2 0 0 0 2 2h7a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-3Zm6.82-3.096a5.51 5.51 0 0 0-2.797-6.293 3.5 3.5 0 1 1 2.796 6.292ZM19.5 18h.5a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-1.1a5.503 5.503 0 0 1-.471.762A5.998 5.998 0 0 1 19.5 18ZM4 7.5a3.5 3.5 0 0 1 5.477-2.889 5.5 5.5 0 0 0-2.796 6.293A3.501 3.501 0 0 1 4 7.5ZM7.1 12H6a4 4 0 0 0-4 4 2 2 0 0 0 2 2h.5a5.998 5.998 0 0 1 3.071-5.238A5.505 5.505 0 0 1 7.1 12Z" clip-rule="evenodd" />
                    </svg>

                    <span class="ml-3 text-lg text-gray-800  ">Learners</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-lg text-gray-800       ">Settings</span>
                </a>
            </li>
        ...
        <ul class="pt-5 mt-5 space-y-8 border-t border-gray-200 ">
            <li>
                <a href="../../controller/formateur/logout.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-lg text-gray-900  ">Logout</span>
                </a>
            </li>
        </ul>
