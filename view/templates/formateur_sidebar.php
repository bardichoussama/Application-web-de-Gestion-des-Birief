<aside id="default-sidebar" class=" mt-7 top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidenav">
    ...
    <div class="overflow-y-auto mt-16 py-5 px-3 h-full bg-bodybackground">
        <ul class="space-y-11">
            <li>
                <a href="../formateur/dashboard_formateur.php" class="flex items-center p-2 text-base font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-xl text-gray-800 ">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="../formateur/create_brief.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-xl text-gray-800  ">Create Brief</span>
                </a>
            </li>
            <li>
                <a href="../formateur/briefs_list.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg  hover:bg-gray-100">
                    ...
                    <span class="ml-3 text-xl text-gray-800  ">Briefs</span>
                </a>
            </li>
            <li>
                <a href="../formateur/learners.php" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100 ">
                    
                <svg class="w-6 h-6 text-primary " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path fill-rule="evenodd" d="M12 6a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm-1.5 8a4 4 0 0 0-4 4 2 2 0 0 0 2 2h7a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-3Zm6.82-3.096a5.51 5.51 0 0 0-2.797-6.293 3.5 3.5 0 1 1 2.796 6.292ZM19.5 18h.5a2 2 0 0 0 2-2 4 4 0 0 0-4-4h-1.1a5.503 5.503 0 0 1-.471.762A5.998 5.998 0 0 1 19.5 18ZM4 7.5a3.5 3.5 0 0 1 5.477-2.889 5.5 5.5 0 0 0-2.796 6.293A3.501 3.501 0 0 1 4 7.5ZM7.1 12H6a4 4 0 0 0-4 4 2 2 0 0 0 2 2h.5a5.998 5.998 0 0 1 3.071-5.238A5.505 5.505 0 0 1 7.1 12Z" clip-rule="evenodd"/>
</svg>

                    <span class="ml-3 text-xl text-gray-800  ">Learners</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                    <svg style="color: #3AAFA9;" class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M8 5a1 1 0 0 1 1-1h11a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2h-1a1 1 0 1 1 0-2h1V6H9a1 1 0 0 1-1-1Z" clip-rule="evenodd"></path>
                        <path fill-rule="evenodd" d="M4 7a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2H4Zm0 11v-5.5h11V18H4Z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="ml-3 text-xl text-gray-800     ">Pages</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg hover:bg-gray-100">
                    ...
                    <span class="ml-3 text-xl text-gray-800       ">Settings</span>
                </a>
            </li>
        </ul>
