...
<div id="docs-sidebar" class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-bodybackground  border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300  ">
    <div class="px-6">
        <a href="../../view/formateur/dashboard_formateur.php" class="flex justify-center items-center text-2xl font-semibold text-gray-900 mt-4"><svg class="w-16 h-16 text-primary  " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <ul class="space-y-11">
            <li>
                <a href="../formateur/dashboard_formateur.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-base text-gray-800 ">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="../formateur/create_brief.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-base text-gray-800  ">Create Brief</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="../formateur/learners.php" class="flex items-center p-2  font-normal text-gray-900 dark:text-gray-200 rounded-lg hover:bg-gray-100 ">
                    ...
                    <span class="ml-3 text-base text-gray-800  ">Learners</span>
                </a>
            </li>
            <li>
